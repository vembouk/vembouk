                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#office" role="tab">Tasks </a> </li>
                                <!--<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#field" role="tab">Field tasks </a> </li>-->
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#c_rfq" role="tab"> Client RFQ</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#v_rfq" role="tab">Vendor RFQ</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#calculations" role="tab">Calculations</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#c_offers" role="tab">Commertial Offers</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#t_offers" role="tab">Technical Offers</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#education" role="tab"> Project Other files</a> </li>
                            ...
                            <div class="card-body"> <small class="text-muted">Start Date </small>
                                ...
                                <br/>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Year Of Project</label>
                                                <input type="text" name="pro_year" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $details->pro_year; ?>" class="form-control" id="recipient-name1" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Reference Number</label>
                                                <input type="text" name="pro_ref" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $details->pro_ref; ?>" class="form-control" id="recipient-name1" required>
                                            </div>
                                             <?php $catvalue1 = $this->project_model->getcategory(); ?>
                                            <div class="form-group">
                                            <label class="control-label">Category</label>
                                                 <select name="cat" value="" class="form-control custom-select" required>
                                            <option>Select Category</option>
                                            <?Php foreach($catvalue1 as $value): ?>
                                             <option value="<?php echo $value->cat_name ?>"><?php echo $value->cat_name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        </div>
                                        <?php $depvalue1 = $this->project_model->getcustomer(); ?>
                                        <div class="form-group">
                                                <label class="control-label">Client Company</label>
                                                 <select name="client_company" value="" class="form-control custom-select" required>
                                            <option>Select Client Company</option>
                                            <?Php foreach($depvalue1 as $value): ?>
                            ...
                            <tbody>
                               <?php foreach($files as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo $value->file_name2?></td>
                                    <td>
                                    ...
                                    <!--<td><?php echo $value->uploaded_by ?></td>-->
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                ...
                                <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                                <form class="row" id="insert_education" action="Add_File" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
			                                    </div>
                                                <div class="form-group col-md-6 m-t-5">
                                                    <label class="control-label">Reference Number</label>
                                                    <input type="text" class="form-control form-control-line" placeholder="" name="ref_no" required>
                                                </div>
                                                <?php $depvalue11 = $this->project_model->getcategory1(); ?>
                                                <div class="form-group col-md-6 m-t-5">
                                                <label class="control-label">Type Of Document</label>
                                                 <select name="details" value="" class="form-control custom-select">
                                            <option>Choose...</option>
                                            <?Php foreach($depvalue11 as $value): ?>
                                             <option value="<?php echo $value->cat_name ?>"><?php echo $value->cat_name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                            </div>
			                                   <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <!--<?php $depvalue11 = $this->employee_model->GetAllEmployee(); ?>
                                                <div class="form-group col-md-6 m-t-5">
                                                <label class="control-label">Uploaded By</label>
                                                 <select name="uploaded_by" value="" class="form-control custom-select" >
                                            <option>Select Who Upload The File</option>
                                            <?Php foreach($depvalue11 as $value): ?>
                                             <option value="<?php echo $value->first_name ?>"><?php echo $value->first_name ?></option>
                                            <?php endforeach; ?>
                                        </select>
...
<!-- Client RFQ Start -->
<div class="tab-pane" id="c_rfq" role="tabpanel">
<div class="card">
	            <div class="card-body">
                    <div class="table-responsive ">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <td class="jsgrid-align-center ">
                            <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                            <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet1" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                            <form class="row" id="insert_education1" action="Add_File1" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
...
<!-- Vendor RFQ  Start-->
<div class="tab-pane" id="v_rfq" role="tabpanel">
<div class="card">
	            <div class="card-body">
                    <div class="table-responsive ">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <td class="jsgrid-align-center ">
                            <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                            <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet2" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                            <form class="row" id="insert_education2" action="Add_File2" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
...
<!-- Calculations Start-->
                            <div class="tab-pane" id="calculations" role="tabpanel">
                            <div class="card">
	            <div class="card-body">
                    <div class="table-responsive ">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <td class="jsgrid-align-center ">
                            <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                            <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet3" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                            <form class="row" id="insert_education3" action="Add_File3" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
...
<!-- Commertial Offers Start-->

<div class="tab-pane" id="c_offers" role="tabpanel">
<div class="card">
	            <div class="card-body">
                    <div class="table-responsive ">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <td class="jsgrid-align-center ">
                            <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                            <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet4" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                            <form class="row" id="insert_education4" action="Add_File4" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
...
<!-- Commertial Offers End-->


<!-- Technical Offers Start -->

<div class="tab-pane" id="t_offers" role="tabpanel">
<div class="card">
	            <div class="card-body">
                    <div class="table-responsive ">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <td class="jsgrid-align-center ">
                            <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                            <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet5" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'||'EMPLOYEE'){ ?>    
			                            <form class="row" id="insert_education5" action="Add_File5" method="post" enctype="multipart/form-data">
			                                	<span id="error"></span>
                                                <div class="form-group col-md-6 m-t-5">
			                                        <label class="control-label">Document Name</label>
			                                        <input type="text" class="form-control form-control-line" placeholder="" name="file_name2" required> 
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".filedelet1").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'FileDeletById1?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
                                                }).done(function (response) {
                                                    console.log(response);
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".filedelet2").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'FileDeletById2?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
                                                }).done(function (response) {
                                                    console.log(response);
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".filedelet3").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'FileDeletById3?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
                                                }).done(function (response) {
                                                    console.log(response);
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".filedelet4").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'FileDeletById4?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
                                                }).done(function (response) {
                                                    console.log(response);
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".filedelet5").click(function (e) {
                                                e.preventDefault(e);
                                                // Get the record's ID via attribute  
                                                var iid = $(this).attr('data-id');
                                                $.ajax({
                                                    url: 'FileDeletById5?id=' + iid,
                                                    method: 'GET',
                                                    data: 'data',
                                                }).done(function (response) {
                                                    console.log(response);
