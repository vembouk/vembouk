...
<?php $this->load->view('backend/sidebar'); ?>
   ...
   <!-- <?php $degvalue = $this->vendor_model->getdesignation(); ?>-->
    <!--<?php $depvalue = $this->vendor_model->getdepartment(); ?>-->
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>vendor/Vendors" class="text-white"><i class="" aria-hidden="true"></i>  vendor List</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-user-o" aria-hidden="true"></i> Add New vendor<span class="pull-right " ></span></h4>
                            </div>
