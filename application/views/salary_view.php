          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group row">
                <label class="control-label text-left col-md-3">Staff Name</label>
                <div class="col-md-9">
              ...
              <div class="col-md-6">                                    
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Gross Salary
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Total hours
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Normal OT Hours
                </label>
                <div class="col-md-7">
                <input type="text" name="hours_worked1" class="form-control hours_worked1" id="" value="">
                </div>
              </div>   
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Holiday OT Hours
                </label>
                <div class="col-md-7">
                <input type="text" name="hours_worked2" class="form-control hours_worked2" id="" value="">
                </div>
              </div>                                     
              ...
              <div class="form-group row" id="loan">
                <label class="control-label text-left col-md-5">Advance
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row" id="addition1">
                <label class="control-label text-left col-md-5">Normal OT Pay
                </label>
                <div class="col-md-7">
                <input type="text" name="addition1" class="form-control" id="" value="">
              </div>
              </div>   
              <div class="form-group row" id="addition2">
                <label class="control-label text-left col-md-5">Holiday OT Pay
                </label>
                <div class="col-md-7">
                <input type="text" name="addition2" class="form-control" id="" value="">
              </div>
              </div>
                                             
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Net Salary
                </label>
                <div class="col-md-7">
      ...
      $(document).ready(function () {
        ...
        $(document).on('click', ".salaryGenerateModal", function (e) {
          ...
          $.ajax({
            ...
            if(response.addition1 == 0) {
                $('#generatePayrollForm').find('[id="addition1"]').val('').hide().end();
            }

            if(response.addition2 == 0) {
                $('#generatePayrollForm').find('[id="addition2"]').val('').hide().end();
            }
            ...
            $('#generatePayrollForm').find('[name="hours_worked1"]').val(response.employee_actually_worked1)/*.attr('readonly', true)*/.end();
            $('#generatePayrollForm').find('[name="hours_worked2"]').val(response.employee_actually_worked2)/*.attr('readonly', true)*/.end();
            $('#generatePayrollForm').find('[name="addition"]').val(response.addition).end();
            $('#generatePayrollForm').find('[name="addition1"]').val(response.addition1).end();
            $('#generatePayrollForm').find('[name="addition2"]').val(response.addition2).end();
