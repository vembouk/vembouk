                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class="text-right"><?php echo $addition[0]->basic; ?> QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Medical Allowance</td>
                                                <td class="text-right"> <?php echo $addition[0]->medical; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class="text-right"><?php echo $addition[0]->house_rent; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Food Allowance</td>
                                                <td class="text-right"><?php echo $addition[0]->conveyance; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Telephone Allowance</td>
                                                <td class="text-right"><?php echo $addition[0]->mob_all; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Washing Allowence</td>
                                                <td class="text-right"><?php echo $addition[0]->washing; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Education Allowence</td>
                                                <td class="text-right"><?php echo $addition[0]->education_allowence; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Special Allowence </td>
                                                <td class="text-right"><?php echo $addition[0]->special_allowence; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Normal OT </td>
                                                <td class="text-right"><?php echo $addition[0]->n_ot; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Holiday OT </td>
                                                <td class="text-right"><?php echo $addition[0]->h_ot; ?>  QR</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Bonus</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php
                                                        if($a > 0) { echo round($a,2).' QR'; }
                                                    ?>
                                                </td>
                                                <td class="text-right">
                                                    <?php
                                                        if($d > 0) { echo round($d,2).' QR'; }
                                                    ?>        
                                                </td>
                                                <td class="text-right"> </td>
                                            </tr>
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                <th>Gross Pay</th>
                                                <th class="text-right"><?php $total_add = $salary_info->basic + $salary_info->medical + $salary_info->house_rent + $salary_info->bonus+$a; echo round($total_add,2); ?> QR</th>
                                                <th class="text-right"><?php $total_did = $salary_info->loan+$salary_info->diduction; echo round($total_did,2); ?> QR</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class="text-right">Net Pay</th>
                                                <th class="text-right"><?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?> QR</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->basic;?> QR</td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->medical;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                 <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->n_ot;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                 <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->h_ot;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->house_rent;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->conveyance;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                 <tr>
                                                    <td>Telephone</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->mob_all;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                 <tr>
                                                    <td>Washing</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->washing;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                  <tr>
                                                    <td>Education</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->education_allowence;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                 <tr>
                                                    <td>Special </td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->special_allowence;?> QR </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>Advance</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right"><?php echo $salary_info->loan;?>  QR</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Gross</th>
                                                    <th class="text-right"><?php echo $salaryvaluebyid->total;?> QR</th>
                                                    <th class="text-right"><?php echo $salary_info->diduction;?>  QR</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Gross :</b>  <?php echo $salary_info->total_pay;?> QR</h3>
                                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Normal OT</label>
                                        <input type="text" name="n_ot" class="form-control" id="recipient-name1"  value="">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Holiday OT</label>
                                        <input type="text" name="h_ot" class="form-control" id="recipient-name1"  value="">
                                    </div>                                      
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mob_all" class="form-control" id="recipient-name1" value="">
                                    </div>      
                                    <div class="form-group">
                                        <label class="control-label">Washing Allowence</label>
                                        <input type="text" name="washing" class="form-control" id="recipient-name1" value="">
                                    </div>  
                                    <div class="form-group">
                                        <label class="control-label">Education Allowence</label>
                                        <input type="text" name="education_allowence" class="form-control" id="recipient-name1" value="">
                                    </div>   
                                    <div class="form-group">
                                        <label class="control-label">Special Allowence</label>
                                        <input type="text" name="special_allowence" class="form-control" id="recipient-name1" value="">
                                    </div>                               
                                    <div class="form-group">
        ...
        $(".SalarylistModal").click(function (e) {
            ...
            $.ajax({
               ...
               /* $('#salaryform').find('[name="typeid"]').val(response.salaryvalue.type_id).end();*/
                ...
                $('#salaryform').find('[name="n_ot"]').val(response.salaryvalue.n_ot).end();
                $('#salaryform').find('[name="h_ot"]').val(response.salaryvalue.h_ot).end();
                $('#salaryform').find('[name="houserent"]').val(response.salaryvalue.house_rent).end();
                $('#salaryform').find('[name="mob_all"]').val(response.salaryvalue.mob_all).end();
                $('#salaryform').find('[name="washing"]').val(response.salaryvalue.washing).end();
                $('#salaryform').find('[name="education_allowence"]').val(response.salaryvalue.education_allowence).end();
                $('#salaryform').find('[name="special_allowence"]').val(response.salaryvalue.special_allowence).end();
