                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
										...
										print '<select type="text" class="form-control" name="pro_year">';
										...
										?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pro_ref" class="form-control" id="recipient-name1"  placeholder="">
                                            </div>
                                            <div class="form-group">
