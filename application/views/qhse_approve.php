                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Request Completion Duration</label><br>
    ...
    $(document).ready(function () {
        ...
        /*DATETIME PICKER*/
          $("#bbbSubmit").on("click", function(event){
              ...
              $.ajax({
                  url: "GetemployeeGmLeave2?year="+datetime+"&typeid="+typeid+"&emid="+emid,
                  type:"GET",
                  dataType:'',
                  data:'data',          
