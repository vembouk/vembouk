...
<?php $this->load->view('backend/sidebar'); ?>
            ...
            <div class="row page-titles">
              ...
              <!--  <?php $degvalue = $this->company_model->getdesignation(); ?>-->
               <!-- <?php $depvalue = $this->company_model->getdepartment(); ?>-->
                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                               ...
                               <!-- <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#bank" role="tab" style="font-size: 14px;"> Bank Account</a> </li>-->
                                ...
                                <!--<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#fleet" role="tab" style="font-size: 14px;"> Fleet Management</a> </li>-->
                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="text" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Enter Registration No" name="eid" value="<?php echo $basic->em_code; ?>"  > 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Name Of The Company</label>
				                                        <input type="text" class="form-control form-control-line" placeholder="Enter Company Name" name="fname" value="<?php echo $basic->first_name; ?>" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Legal Status</label>
				                                        <input type="text" id="" name="lname" class="form-control form-control-line" value="<?php echo $basic->last_name; ?>" placeholder="Company Legal Status" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Establishment Number</label>
				                                        <input type="text" id="" name="est_no" class="form-control form-control-line" value="<?php echo $basic->est_no; ?>" placeholder="Establishment Number" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                     <div class="form-group col-md-4 m-t-10">
				                                        <label>Year Of Establishment</label>
				                                        <input type="text" id="" name="est_year" class="form-control form-control-line" value="<?php echo $basic->est_year; ?>" placeholder="Year Of Establishment" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3"> 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>CR Number</label>
				                                        <input type="text" id="" name="cr_no" class="form-control form-control-line" value="<?php echo $basic->cr_no; ?>" placeholder="CR Number" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Chamber of Commerce Reg No</label>
				                                        <input type="text" id="" name="ccr_no" class="form-control form-control-line" value="<?php echo $basic->ccr_no; ?>" placeholder="Chamber of Commerce Reg No" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>CR Issue Date</label>
				                                        <input type="text" id="" name="startdate" class="form-control mydatepicker" value="<?php echo $basic->startdate; ?>" placeholder="CR Issue Date" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>CR Expiry Date</label>
				                                        <input type="text" id="" name="enddate" class="form-control mydatepicker" value="<?php echo $basic->enddate; ?>" placeholder="CR Expiry Date" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Nature Of Business</label>
				                                        <input type="text" id="" name="bussiness_nature" class="form-control form-control-line" value="<?php echo $basic->bussiness_nature; ?>" placeholder="Nature Of Business" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
                                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Name of Associated Company</label>
				                                        <input type="text" id="" name="name_ass" class="form-control form-control-line" value="<?php echo $basic->name_ass; ?>" placeholder="Name of Associated Company" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> minlength="3" > 
				                                    </div>
	                                    ...
	                                    <div class="card-body">
                                            ...
                                            <div class="form-group col-md-4 m-t-10">
                                                ...
                                                <div class="form-group col-md-4 m-t-10">
			                                        ...
			                                        <input type="text" name="next_review" value="<?php if(!empty($auditinfo->next_review)) echo $auditinfo->next_review?>" class="form-control mydatepicker"  > 
			                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="row" action="Add_File" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6 m-t-5">
				                                        ...
				                                        <input type="text" name="cer_no" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control" required="" aria-invalid="false" required > 
				                                    </div>
                                ...
                                <?php endforeach; ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group col-md-6 m-t-5">
				                                        ...
				                                        <input type="text" name="veh_name" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control" required="" aria-invalid="false" required > 
				                                    </div>
                                        <div class="form-group col-md-6 m-t-5">
