...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>Vehicle Application</h3>
        </div>
        ...
        <div class="modal fade" id="appmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content ">
                            ...
                            <?php $depvalue1 = $this->employee_model->emselect(); ?>
                            <div class="form-group">
                                ...
                                <?php $depvalue2 = $this->vehicle_model->emselect(); ?>
                                <div class="form-group">
                               ...
                               <!--  <div class="form-group" >
                                ...
                                <div class="form-group">
                                    <label class="control-label">Detail description of repairs/maintenance needed</label>
