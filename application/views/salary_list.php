                                        ...
                                        <tbody>
                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td><?php echo 'QR'.$individual_info->basic; ?></td>
                                                <td><?php echo 'QR'.$individual_info->loan; ?></td>
                                                <td><?php echo $individual_info->total_days; ?></td>
                                                <!--<td><?php echo $individual_info->addition; ?></td>-->
                                                <td><?php echo 'QR'.$individual_info->diduction; ?></td>
                                                <td><?php echo 'QR'.$individual_info->total_pay; ?></td>
