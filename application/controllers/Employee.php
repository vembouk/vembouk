...
class Employee extends CI_Controller {
    ...
    $qid_expiry = $this->input->post('qid_expiry');
    ...
    public function view(){
        ...
        $data['fileinfo1'] = $this->employee_model->GetFileInfo1($id);
    ...
    $filetitle1 = $this->input->post('title1'); 
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters();
...
public function Add_File1(){
        ...
        $doc_type = $this->input->post('doc_type');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $success = $this->employee_model->File_Upload1($data); 
                #$this->session->set_flashdata('feedback','Successfully Updated');
                #redirect("employee/view?I=" .base64_encode($em_id));
                    echo "Successfully Updated";
                }
    ...
    public function Add_Salary(){
        ...
        $mob_all = $this->input->post('mob_all');
        $washing = $this->input->post('washing');
        $education_allowence = $this->input->post('education_allowence');
        $special_allowence = $this->input->post('special_allowence');
        $n_ot = $this->input->post('n_ot');
        $h_ot = $this->input->post('h_ot');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!empty($sid)){
                ...
                $data1 = array(
                    ...
                    'mob_all' => $mob_all,
                    'washing' => $washing,
                    'education_allowence' => $education_allowence,
