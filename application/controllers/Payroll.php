   ...
   /* public function Salary_List(){
    ...
    public function Add_Sallary_Pay(){
        if($this->session->userdata('user_login_access') != False) {
            ...
            $totalday1 = $this->input->post('hours_worked1');
            $totalday2 = $this->input->post('hours_worked2');
...
$obj_merged = (object) array_merge((array) $employee_info, (array) $salaryvaluebyid, (array) $salarypaybyid, (array) $salaryvalue, (array) $loanvaluebyid);
                        ...
                        <div class='card card-body'>
                            <div class='row'>
                                <div class='col-md-4 col-xs-6 col-sm-6'>
                                    <img src='$base/assets/images/logo1.png' style=' width:180px; margin-right: 10px;' />
                                </div>
                            ...
                            <div class='row'>
                                <div class='col-md-12 text-left'>
                                    <h5 style='margin-top: 15px;'>Payslip for the Month of $salary_info->month $salary_info->year</h5>
                                </div>
                            </div>
                                ...
                                <div class='col-md-12'>
                                    <table class='table table-condensed borderless' style='border-left: 1px solid #ececec;'>
                                        ...
                                        <tbody style='border: 1px solid #ececec;'>
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class='text-right'>". $addition[0]->basic; echo" QR</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>Medical Allowance</td>
                                                <td class='text-right'>". $addition[0]->medical; echo " QR</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class='text-right'>".$addition[0]->house_rent; echo " QR</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>Conveyance Allowance</td>
                                                <td class='text-right'>".$addition[0]->conveyance; echo " QR</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                            <td>Telephone Allowance</td>
                                            <td class='text-right'>".$addition[0]->mob_all; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                            <td>Washing Allowance</td>
                                            <td class='text-right'>".$addition[0]->washing; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                            <td>Education Allowance</td>
                                            <td class='text-right'>".$addition[0]->education_allowence; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                            <td>Special Allowance</td>
                                            <td class='text-right'>".$addition[0]->special_allowence; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>
                                            <!--<tr>
                                            <td>Normal OT</td>
                                            <td class='text-right'>".$addition[0]->n_ot; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>-->
                                            <tr>
                                                <td>Normal OT($salary_info->total_days1 hrs)</td>
                                                <td class='text-right'>"; if(!empty($salary_info->addition1)) {
                                                    echo $salary_info->addition1;
                                                }; echo " QR</td>
                                                <td class='text-right'> </td>
                                            </tr>
                                            <tr>
                                                <td>Holiday OT($salary_info->total_days2 hrs)</td>
                                                <td class='text-right'>"; if(!empty($salary_info->addition2)) {
                                                    echo $salary_info->addition2;
                                                }; echo " QR</td>
                                                <td class='text-right'> </td>
                                            </tr>
                                            <!--<tr>
                                                <td>Extra Regular time</td>
                                                <td class='text-right'>"; if(!empty($salary_info->addition)) {
                                                    echo $salary_info->addition;
                                                }; echo " QR</td>
                                                <td class='text-right'> </td>
                                            </tr>-->
                                            <!--<tr>
                                            <td>Holiday OT</td>
                                            <td class='text-right'>".$addition[0]->h_ot; echo " QR</td>
                                            <td class='text-right'>  </td>
                                            </tr>-->
                                            <!--<tr>
                                                <td>Bonus</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class='text-right'>"; if(!empty($salary_info->loan)) {
                                                    echo "$salary_info->loan QR"; 
                                                }; echo " </td>
                                            </tr>
                                            
                                            <tr>
                                                <td>Lose of Pay Hours Worked ($salary_info->total_days hrs)</td>
                                                <td class='text-right'>
                                                </td>
                                                <td class='text-right'>
                                                         $salary_info->diduction QR 
                                                </td>
                                                <td class='text-right'> </td>
                                            </tr>
                                        ...
                                        <tfoot class='tfoot-light'>
                                            <tr>
                                                <th>Gross Pay</th>
                                                <th class='text-right'>". $total_add = $salary_info->basic + $salary_info->medical + $salary_info->addition1 + $salary_info->addition2 + $salary_info->addition + $salary_info->house_rent + $salary_info->bonus;  round($total_add,2); echo " QR</th>
                                                <th class='text-right'>".$total_did = $salary_info->loan + $salary_info->diduction;  round($total_did,2); echo " QR</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class='text-right'>Net Pay</th>
                                                <th class='text-right'>$salary_info->total_pay QR</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
    ...
    private function hours_worked_by_employee1($employeeID, $start_date, $end_date) {
        return $this->payroll_model->totalHoursWorkedByEmployeeInAMonth1($employeeID, $start_date, $end_date);
    }

    private function hours_worked_by_employee2($employeeID, $start_date, $end_date) {
        return $this->payroll_model->totalHoursWorkedByEmployeeInAMonth2($employeeID, $start_date, $end_date);
    }
    ...
    public function GetSalaryByWorkdays(){
        ...
        $data['employee_actually_worked1'] = $employee_actually_worked1[0]->Hours;
        $data['employee_actually_worked2'] = $employee_actually_worked2[0]->Hours;
    ...
    public function pay_salary_add_record() {
        ...
        $hours_worked1 = $this->input->post('hours_worked1');
        $hours_worked2 = $this->input->post('hours_worked2');
        $addition = $this->input->post('addition');
        $addition1 = $this->input->post('addition1');
        $addition2 = $this->input->post('addition2');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'total_days1' => $hours_worked1,
                'total_days2' => $hours_worked2,
                'basic' => $basic,
                'loan' => $loan,
    ...
    public function generate_payroll_for_each_employee(){
        ...
        $employee_actually_worked1 = $this->hours_worked_by_employee1($employeePIN->em_code, $start_date, $end_date);  // in normal OT hours
        

        $employee_actually_worked2 = $this->hours_worked_by_employee2($employeePIN->em_code, $start_date, $end_date); // in holiday OT hours
        ...
        // Hourly rate for the month
        $hourly_rate = $employee_salary / $total_work_hours;
        //$hourly_rate = (($employee_salary /30)/8) *1.25;
        ...
        if($work_hour_diff < 0) {
            ...
            // 80 is > 0 which means he worked less, so diduction = 80 hrs
            // so 80 * hourly rate 208 taka = 17500
            $diduction = ($employee_salary / 30) * ($work_hour_diff/8);
        }
        ...
        $employee_salary1 = $this->payroll_model->GetsalaryValueByID($employeeID);
// Normal OT add with net pay calculation

        if($employee_salary1) {
            $employee_salary1 = $employee_salary1->basic;
        }

        // Hourly rate for the month
        //$hourly_rate = $employee_salary / $total_work_hours;
        $hourly_rate1 = (($employee_salary1 /30)/8) *1.25;
        
        $work_hour_diff1 =abs($employee_actually_worked1[0]->Hours); // 96 - 16 = 80

        $addition1 = 0;
        $diduction1 = 0;
        if($work_hour_diff1 > 0) {
            $addition1 = abs($work_hour_diff1) * $hourly_rate1;
        } else if($work_hour_diff1 > 0) {
            // 80 is > 0 which means he worked less, so diduction = 80 hrs
            // so 80 * hourly rate 208 taka = 17500
            $diduction1 = abs($work_hour_diff) * $hourly_rate;
        }

// Holiday OT add with net pay calculation

$employee_salary2 = $this->payroll_model->GetsalaryValueByID($employeeID);


        if($employee_salary2) {
            $employee_salary2 = $employee_salary2->basic;
        }

        // Hourly rate for the month
        //$hourly_rate = $employee_salary / $total_work_hours;
        $hourly_rate2 = (($employee_salary2 /30)/8) * 1.50;
        
        $work_hour_diff2 =abs($employee_actually_worked2[0]->Hours); // 96 - 16 = 80

        $addition2 = 0;
        $diduction2 = 0;
        if($work_hour_diff2 > 0) {
            $addition2 = abs($work_hour_diff2) * $hourly_rate2;
        } else if($work_hour_diff2 > 0) {
            // 80 is > 0 which means he worked less, so diduction = 80 hrs
            // so 80 * hourly rate 208 taka = 17500
            $diduction2 = abs($work_hour_diff) * $hourly_rate;
        }
        ...
        // Final Salary
        $final_salary = $employee_salary  + $addition1  + $addition2 - $diduction - $loan_amount;
        ...
        $data['addition1'] = round($addition1,2);
        $data['addition2'] = round($addition2,2);
        $data['diduction'] = round($diduction, 2);
        $data['diduction1'] = round($diduction1, 2);
