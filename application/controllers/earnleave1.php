                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           <?php foreach($earnleave1 as $value): ?>
                                            <tr>
                        ...
                        <div class="modal fade" id="earnmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    ...
                                    <form method="post" action="Update_Earn_Leave1" id="earnform" enctype="multipart/form-data">
                        ...
                        <div class="modal fade" id="earndeductionmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    ...
                                    <form method="post" action="Update_Earn_Leave_Only1" id="deductionform" enctype="multipart/form-data">
                                    <div class="modal-body">
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            $(".deductionmodel").click(function (e) {
                                                ...
                                                $.ajax({
                                                    url: 'GetEarneBalanceByEmCode1?id=' + iid,
                                                    method: 'GET',
                                                    data: '',
                                                    dataType: 'json',
